...
/**
 * Author: Ramesh Mourya Description: This class will store all the locators on
 * Sales App Home page and required methods.
 */
...
public class SalesHomePage extends CommonFunction {
	...
	// opptyMenuOption=By.cssSelector("a[title='Opportunities']
	// span[class='slds-truncate']");
	public static final By opptyPgRecentlyViewed = By.xpath(
	...
	public CreateOpptyPage NavigatetoOpptyPage() throws IOException {
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(opptyMenuOption));
	...
	public boolean isOpportunityMenuOptionVisible()
	{
		return checkPageExistence(opptyMenuOption);
	}
